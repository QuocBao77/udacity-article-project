...
class Config(object):
    ...
    BLOB_ACCOUNT = os.environ.get('BLOB_ACCOUNT') or 'storagebaotq16'
    ...
    CLIENT_SECRET = "iQM8Q~kZQrPbCi56~iWnfAuJRgHPXw5B367Xvcj5"
    ...
    CLIENT_ID = "c57bc0da-a4c6-4ae2-9394-3e504a2dc174"
